...
class ModelTrainer:
    ...
    def train(
        ...
        main_evaluation_metric: Tuple[str, str] = ("macro avg", "f1-score"),
        scheduler=AnnealOnPlateau,
        anneal_factor: float = 0.5,
        patience: int = 3,
        min_learning_rate: Union[float, List[float]] = 0.0001,
        initial_extra_patience: int = 0,
        optimizer: Union[torch.optim.Optimizer, Type[torch.optim.Optimizer]] = Adam,
        ...
        metrics_for_tensorboard=[("macro avg", 'f1-score'), ("macro avg", 'precision'), ("macro avg", 'recall'), ("weighted avg", 'f1-score'), ("weighted avg", 'precision'), ("weighted avg", 'recall')],
            ...
            try:
                ...
                for epoch in range(epoch + 1, max_epochs + 1):
                    ...
                    if log_test:
                        ...
                        classification_reports.append(test_eval_result.classification_report)
                ...
                ClassReportsPickle = open('./resources/ClassificationReports', 'ab')
                pickle.dump(classification_reports, ClassReportsPickle)
                ClassReportsPickle.close() 
